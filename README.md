...
*Experience the power of AI-driven plant health analysis*
...
- **Streamlit Frontend (streamlit_app.py)**: Interactive web interface with modern UI/UX design
- **Core AI Engine (core.py)**: Advanced disease detection engine powered by Meta Llama Vision
...
- **🚀 streamlit_app.py** - Streamlit Web Application with interactive UI components, real-time image preview, results visualization, and modern CSS styling
...
- **🧠 core.py** - Core AI Detection Engine containing the LeafDiseaseDetector class, DiseaseAnalysisResult dataclass, Groq API integration, base64 image processing, response parsing
...
- **📁 Media/** - Sample test image for development and testing
...
**Terminal 2: Launch Streamlit** - streamlit run streamlit_app.py --server.port 8501
...
**Test via Swagger UI:**
Access the interactive API documentation at http://localhost:8000/docs to test the endpoints directly through the browser interface.

#### Testing Direct Detection Engine
**Test the core AI detection system:**
Import LeafDiseaseDetector from core, initialize detector, load and encode test image with base64, then analyze image to get detection results.
...
#### Modify Visual Theme in streamlit_app.py:
...
- streamlit_app.py (Streamlit frontend with UI/UX focus)
- app.py (FastAPI backend with API endpoints)
- core.py (Core AI detection engine)
- utils.py (Shared utilities and helpers)
- Media/ (Sample test image)
